...
public class ProduitRestController {
	...
	@ResponseBody
	public ProduitDTO addProduit(@Valid @RequestBody ProduitDTO p) {
		ProduitDTO produit = produitService.addProduit(p);
		return produit;
	}
	...
	@ResponseBody
	public ProduitDTO modifyProduit(@Valid @RequestBody ProduitDTO p) {
